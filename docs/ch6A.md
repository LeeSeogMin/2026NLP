...
| 00:55~01:25 | 라이브 코딩 시연 (API 호출 + Function Calling) | 교수 시연 시 선택 사용 |
...
- Sahoo, P., et al. (2024). A Systematic Survey of Prompt Engineering in Large Language Models. *arXiv*. https://arxiv.org/abs/2402.07927
