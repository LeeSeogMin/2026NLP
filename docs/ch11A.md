...
| 00:55~01:25 | 라이브 코딩 시연 (PDF → Vector DB → 자연어 Q&A) | 교수 시연 시 선택 사용 |
...
> **라이브 코딩 시연**: 교수가 실제 PDF 문서를 로드하여 벡터 DB에 저장하고, 자연어 질문으로 검색하여 LLM이 답변을 생성하는 전체 파이프라인을 구현한다.
...
3. Thawani, A. et al. (2021). Evaluating Factuality in Generation with Dependency-level Entailment. *EMNLP Findings*. https://arxiv.org/abs/2010.05873
4. Su, D. et al. (2022). Multi-Hop Question Answering over Paragraph Collections. *NAACL*. https://arxiv.org/abs/2106.01231
5. Raffel, C. et al. (2020). Exploring the Limits of Transfer Learning with a Unified Text-to-Text Transformer. *JMLR*. https://arxiv.org/abs/1910.10683
6. Izacard, G. & Grave, E. (2021). Leveraging Passage Retrieval to Improve In-Context Learning for Question Answering. *EACL*. https://arxiv.org/abs/2110.08504
