...
> **라이브 코딩 시연**: 교수가 웹 검색, 계산, 데이터베이스 조회 도구를 정의하고, LangGraph로 간단한 Agent를 만든 뒤, 실제로 복잡한 질문에 답하는 과정을 보여준다.
...
(A) Chatbot의 답변 예상: _________________

(B) ReAct Agent의 답변 예상: _________________

(C) 두 답변이 다른 이유: _________________
...
1. Wei, J., Wang, X., Schuurmans, D., et al. (2022). Chain-of-Thought Prompting Elicits Reasoning in Large Language Models. *arXiv*. https://arxiv.org/abs/2201.11903
2. Yao, S., Zhao, J., Yu, D., et al. (2022). ReAct: Synergizing Reasoning and Acting in Language Models. *arXiv*. https://arxiv.org/abs/2210.03629
...
6. Mialon, G., Dessì, R., Lomeli, M., et al. (2023). Augmented Language Models: a Survey. *arXiv*. https://arxiv.org/abs/2302.07842
7. Park, J. S., O'Neill, J., & Jiang, L. (2023). Social Simulacra: Creating Populated Worlds with Large Language Models. *arXiv*. https://arxiv.org/abs/2208.04024
