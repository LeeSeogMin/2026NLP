...
| 00:55~01:25 | 라이브 코딩 시연 (Scaled Dot-Product Attention NumPy 구현) | 교수 시연 시 선택 사용 |
...
"커피"와 "차"는 같은 문맥(___ 를 마셨다)에 등장하므로 비슷한 벡터로 표현된다.
...
"나는 **프랑스에서** 10년간 살면서 다양한 문화를 경험했고, 많은 사람들과 교류하며 새로운 언어도 배우고 ... (중략) ... 그래서 나는 ___를 잘한다."
